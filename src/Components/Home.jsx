...
<div className="carousel-inner">
  ...
  <div className="carousel-item">
    <div className="d-block w-60 m-auto">
      <ul>
        <li>02 Mar. 2021: We have an opening for a JRF position. Details can be found here</li>
...
<button className="carousel-control-next" type="button" data-bs-target="#carouselExampleDark" data-bs-slide="next">
 ...
 {/* carousel end here  */}
<div className="last-element-page"><p>We will be hiring soon for <a href="https://www.indokoreajnc.in/">Indo-South Korea
  Joint Network Centre for Environemntal Cyber Physical Systems</a></p></div>
        </div>
</>
    )
}
